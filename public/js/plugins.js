...
jQuery(document).ready(function(s) {
    ...
    function a(i) {
        ...
        i.each(function() {
            var i = s(this);
            if (i.hasClass("loading-bar")) e = h, setTimeout(function() { i.find(".cd-words-wrapper").addClass("is-loading") }, u);
                ...
                var d = 0;
                i.find(".cd-words-wrapper b").each(function() {
                    var i = s(this).width();
                    i > d && (d = i)
                }), i.find(".cd-words-wrapper").css("width", d)
            }
            setTimeout(function() { n(i.find(".is-visible").eq(0)) }, e)
        })
    }
    ...
    function n(s) {
        ...
        if (s.parents(".cd-headline").hasClass("type")) {
            ...
            e.addClass("selected").removeClass("waiting"), setTimeout(function() { e.removeClass("selected"), s.removeClass("is-visible").addClass("is-hidden").children("i").removeClass("in").addClass("out") }, C), setTimeout(function() { t(i, f) }, m)
        ...
        } else s.parents(".cd-headline").hasClass("clip") ? s.parents(".cd-words-wrapper").animate({ width: "2px" }, w, function() { o(s, i), t(i) }) : s.parents(".cd-headline").hasClass("loading-bar") ? (s.parents(".cd-words-wrapper").removeClass("is-loading"), o(s, i), setTimeout(function() { n(i) }, h), setTimeout(function() { s.parents(".cd-words-wrapper").addClass("is-loading") }, u)) : (o(s, i), setTimeout(function() { n(i) }, c))
    }

    function t(s, i) { s.parents(".cd-headline").hasClass("type") ? (l(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".cd-headline").hasClass("clip") && s.parents(".cd-words-wrapper").animate({ width: s.width() + 10 }, w, function() { setTimeout(function() { n(s) }, v) }) }

    function d(i, e, a, t) {
        if (i.removeClass("in").addClass("out"), i.is(":last-child") ? a && setTimeout(function() { n(r(e)) }, c) : setTimeout(function() { d(i.next(), e, a, t) }, t), i.is(":last-child") && s("html").hasClass("no-csstransitions")) {
            var l = r(e);
            o(e, l)
        }
    }

    function l(s, i, e, a) { s.addClass("in").removeClass("out"), s.is(":last-child") ? (i.parents(".cd-headline").hasClass("type") && setTimeout(function() { i.parents(".cd-words-wrapper").addClass("waiting") }, 200), e || setTimeout(function() { n(i) }, c)) : setTimeout(function() { l(s.next(), i, e, a) }, a) }

    function r(s) { return s.is(":last-child") ? s.parent().children().eq(0) : s.next() }

    function o(s, i) { s.removeClass("is-visible").addClass("is-hidden"), i.removeClass("is-hidden").addClass("is-visible") }
    var c = 2500,
        h = 3800,
        u = h - 3e3,
        p = 50,
...
! function(t, i) { "function" == typeof define && define.amd ? define(["jquery"], i) : "object" == typeof exports ? module.exports = i(require("jquery")) : t.lightbox = i(t.jQuery) }(this, function(t) {
    ...
    return i.defaults = { albumLabel: "Image %1 of %2", alwaysShowNavOnTouchDevices: !1, fadeDuration: 600, fitImagesInViewport: !0, imageFadeDuration: 600, positionFromTop: 50, resizeDuration: 700, showImageNumberLabel: !0, wrapAround: !1, disableScrolling: !1, sanitizeTitle: !1 }, i.prototype.option = function(i) { t.extend(this.options, i) }, i.prototype.imageCountLabel = function(t, i) { return this.options.albumLabel.replace(/%1/g, t).replace(/%2/g, i) }, i.prototype.init = function() {
        ...
        function e(t) { n.album.push({ link: t.attr("href"), title: t.attr("data-title") || t.attr("title") }) }
        var n = this,
            o = t(window);
        ...
        if (r) { a = t(i.prop("tagName") + '[data-lightbox="' + r + '"]'); for (var h = 0; h < a.length; h = ++h) e(t(a[h])), a[h] === i[0] && (s = h) } else if ("lightbox" === i.attr("rel")) e(i);
        else { a = t(i.prop("tagName") + '[rel="' + i.attr("rel") + '"]'); for (var l = 0; l < a.length; l = ++l) e(t(a[l])), a[l] === i[0] && (s = l) }
        var d = o.scrollTop() + this.options.positionFromTop,
            g = o.scrollLeft();
        this.$lightbox.css({ top: d + "px", left: g + "px" }).fadeIn(this.options.fadeDuration), this.options.disableScrolling && t("body").addClass("lb-disable-scrolling"), this.changeImage(s)
        ...
        o !== s || a !== r ? this.$outerContainer.animate({ width: s, height: r }, this.options.resizeDuration, "swing", function() { e() }) : e()
        ...
        var t = !1;
        try { document.createEvent("TouchEvent"), t = this.options.alwaysShowNavOnTouchDevices ? !0 : !1 } catch (i) {}
        ...
        if ("undefined" != typeof this.album[this.currentImageIndex].title && "" !== this.album[this.currentImageIndex].title) {
            ...
            this.options.sanitizeTitle ? e.text(this.album[this.currentImageIndex].title) : e.html(this.album[this.currentImageIndex].title), e.fadeIn("fast").find("a").on("click", function(i) { void 0 !== t(this).attr("target") ? window.open(t(this).attr("href"), t(this).attr("target")) : location.href = t(this).attr("href") })
        }
        ...
        this.$outerContainer.removeClass("animating"), this.$lightbox.find(".lb-dataContainer").fadeIn(this.options.resizeDuration, function() { return i.sizeOverlay() })
    ...
    }, i.prototype.enableKeyboardNav = function() { t(document).on("keyup.keyboard", t.proxy(this.keyboardAction, this)) }, i.prototype.disableKeyboardNav = function() { t(document).off(".keyboard") }, i.prototype.keyboardAction = function(t) {
        var i = 27,
            e = 37,
            n = 39,
            o = t.keyCode,
            a = String.fromCharCode(o).toLowerCase();
        o === i || a.match(/x|o|c/) ? this.end() : "p" === a || o === e ? 0 !== this.currentImageIndex ? this.changeImage(this.currentImageIndex - 1) : this.options.wrapAround && this.album.length > 1 && this.changeImage(this.album.length - 1) : ("n" === a || o === n) && (this.currentImageIndex !== this.album.length - 1 ? this.changeImage(this.currentImageIndex + 1) : this.options.wrapAround && this.album.length > 1 && this.changeImage(0))
...
! function($) {
    ...
    $.fn.meanmenu = function(e) {
        var n = { meanMenuTarget: jQuery(this), meanMenuContainer: ".xboot-mobile-menu-area", meanMenuClose: "X", meanMenuCloseSize: "18px", meanMenuOpen: "<span /><span /><span />", meanRevealPosition: "right", meanRevealPositionDistance: "0", meanRevealColour: "", meanScreenWidth: "991", meanNavPush: "", meanShowChildren: !0, meanExpandableChildren: !0, meanExpand: "+", meanContract: "-", meanRemoveAttrs: !1, onePage: !1, meanDisplay: "block", removeElements: "" };
        e = $.extend(n, e);
...
! function() {
    ...
    function t() {
        if (!X && document.body) {
            ...
            var t = document.body,
                ...
                r = t.scrollHeight;
            if (Y = document.compatMode.indexOf("CSS") >= 0 ? o : t, k = t, e(), top != self) O = !0;
                ...
                var i;
                M = function() { i || (i = setTimeout(function() { L || (a.style.height = "0", a.style.height = Y.scrollHeight + "px", i = null) }, 500)) }, setTimeout(M, 10), f("resize", M);
                var l = { attributes: !0, childList: !0, characterData: !1 };
                if (D = new $(M), D.observe(t, l), Y.offsetHeight <= n) {
    ...
    function o() { D && D.disconnect(), w(_, r), w("mousedown", i), w("keydown", a), w("resize", M), w("load", t) }
    ...
    function n(e, t, o) {
        ...
        if (P.push({ x: t, y: o, lastX: 0 > t ? .99 : -.99, lastY: 0 > o ? .99 : -.99, start: Date.now() }), !R) {
            var i = e === document.body,
                l = function(n) {
                    for (var r = Date.now(), a = 0, c = 0, u = 0; u < P.length; u++) {
                        var d = P[u],
                            s = r - d.start,
                            m = s >= z.animationTime,
                        ...
                        var w = d.x * f - d.lastX >> 0,
                            h = d.y * f - d.lastY >> 0;
                        a += w, c += h, d.lastX += w, d.lastY += h, m && (P.splice(u, 1), u--)
                    }
                    if (i) {
                        window.scrollBy(a, c);
                        var p;
                        document.createEvent ? (p = document.createEvent("HTMLEvents"), p.initEvent("smoothScrollCustomEvent", !0, !0)) : (p = document.createEventObject(), p.eventType = "smoothScrollCustomEvent"), p.eventName = "smoothScrollCustomEvent", document.createEvent ? window.dispatchEvent(p) : window.fireEvent("on" + p.eventType, p)
                    } else a && (e.scrollLeft += a), c && (e.scrollTop += c);
                    t || o || (P = []), P.length ? W(l, e, 1e3 / z.frameRate + 1) : R = !1
                };
            W(l, e, 0), R = !0
        }
    }
    ...
    function r(e) {
        ...
        B && (e.wheelDeltaX && y(e.wheelDeltaX, 120) && (r = -120 * (e.wheelDeltaX / Math.abs(e.wheelDeltaX))), e.wheelDeltaY && y(e.wheelDeltaY, 120) && (a = -120 * (e.wheelDeltaY / Math.abs(e.wheelDeltaY)))), r || a || (a = -e.wheelDelta || 0), 1 === e.deltaMode && (r *= 40, a *= 40);
        var i = u(o);
        return i ? !z.touchpadSupport && v(a) ? !0 : (Math.abs(r) > 1.2 && (r *= z.stepSize / 120), Math.abs(a) > 1.2 && (a *= z.stepSize / 120), n(i, r, a), e.preventDefault(), void l()) : O && Q ? (Object.defineProperty(e, "target", { value: window.frameElement }), parent.wheel(e)) : !0
    }
    ...
    function a(e) {
        ...
        switch (s == document.body && (m = window.innerHeight), e.keyCode) {
            ...
            case K.home:
                ...
                break;
            case K.end:
                var f = s.scrollHeight - s.scrollTop,
                    w = f - m;
                d = w > 0 ? w + 10 : 0;
                break;
            case K.left:
    ...
    function i(e) { k = e.target }

    function l() { clearTimeout(T), T = setInterval(function() { F = {} }, 1e3) }
    ...
    function p(e, t) { e = e > 0 ? 1 : -1, t = t > 0 ? 1 : -1, (N.x !== e || N.y !== t) && (N.x = e, N.y = t, P = [], q = 0) }

    function v(e) { return e ? (A.length || (A = [e, e, e]), e = Math.abs(e), A.push(e), A.shift(), clearTimeout(C), C = setTimeout(function() { try { localStorage.SS_deltaBuffer = A.join(",") } catch (e) {} }, 1e3), !b(120) && !b(100)) : void 0 }

    function y(e, t) { return Math.floor(e / t) == e / t }

    function b(e) { return y(A[0], e) && y(A[1], e) && y(A[2], e) }
    ...
    function E(e) { for (var t in e) H.hasOwnProperty(t) && (z[t] = e[t]) }
    var k, D, M, T, C, H = { frameRate: 150, animationTime: 400, stepSize: 100, pulseAlgorithm: !0, pulseScale: 4, pulseNormalize: 1, accelerationDelta: 50, accelerationMax: 3, keyboardSupport: !0, arrowScroll: 50, touchpadSupport: !1, fixedBackground: !0, excluded: "" },
        z = H,
        L = !1,
        O = !1,
        N = { x: 0, y: 0 },
        ...
        j = { 37: 1, 38: 1, 39: 1, 40: 1 },
        P = [],
        R = !1,
        q = Date.now(),
        V = function() { var e = 0; return function(t) { return t.uniqueID || (t.uniqueID = e++) } }(),
        F = {};
    if (window.localStorage && localStorage.SS_deltaBuffer) try { A = localStorage.SS_deltaBuffer.split(",") } catch (I) {}
    var _, W = function() { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e, t, o) { window.setTimeout(e, o || 1e3 / 60) } }(),
